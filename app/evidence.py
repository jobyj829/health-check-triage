...
SYMPTOM_WATCH_FOR = {
    ...
    "eye_problem": [
        "Sudden loss of vision in one eye or a curtain/shadow across your vision",
        "Severe eye pain with nausea, halos around lights, or redness",
        "Eye swelling with fever or difficulty moving the eye",
        "Worsening redness, discharge, or pain despite treatment",
    ],
    "fracture": [
        "Increasing numbness, tingling, or fingers/toes turning pale or blue",
        "Inability to move the injured area or bear weight",
        "Increasing pain or swelling despite rest and ice",
    ],
    "pelvic_pain": [
        "Sudden severe pelvic pain with dizziness or fainting",
        "Heavy vaginal bleeding, especially if you might be pregnant",
    ...
    "laceration": [
        ...
        "Numbness or inability to move past the wound",
    ],
    "swelling": [
        "Sudden swelling in one leg with pain (could be a blood clot)",
        "Swelling with shortness of breath or chest pain",
        "Swelling with redness, warmth, and fever (could be infection)",
    ],
    "extremity_pain": [
        "Sudden onset of severe pain with a cold, pale, or blue limb",
        "Deformity, inability to move, or a popping sensation",
        "Pain that gets rapidly worse or doesn't respond to rest",
    ],
    "cough": [
        "Coughing up blood or pink frothy mucus",
        "High fever with worsening cough and shortness of breath",
        "Cough lasting more than 3 weeks or with unexplained weight loss",
    ],
    "sore_throat": [
        "Drooling, inability to swallow, or trouble breathing",
        "Muffled voice with difficulty opening your mouth",
        "High fever with sore throat and a spreading rash",
    ],
}
...
SYMPTOM_ESCALATION = {
    ...
    "cough": [
        {"if_sign": "you cough up blood or pink frothy mucus",
         "then_action": "Go to the Emergency Department immediately", "severity": "critical"},
        {"if_sign": "you develop a high fever with worsening cough and trouble breathing",
         "then_action": "Go to the Emergency Department", "severity": "urgent"},
        {"if_sign": "your cough lasts more than 3 weeks or keeps getting worse",
         "then_action": "See your doctor within the next few days", "severity": "watch"},
    ],
    "sore_throat": [
        {"if_sign": "you start drooling, can't swallow, or have trouble breathing",
         "then_action": "Call 911 immediately \u2014 this could be epiglottitis or a throat abscess", "severity": "critical"},
        {"if_sign": "your voice sounds muffled and you can barely open your mouth",
         "then_action": "Go to the Emergency Department \u2014 this could be a peritonsillar abscess", "severity": "critical"},
        {"if_sign": "your sore throat gets worse after 3 days or comes with a high fever and rash",
         "then_action": "See a doctor within 24 hours", "severity": "urgent"},
    ],
    "eye_problem": [
        {"if_sign": "you suddenly lose vision in one eye",
         "then_action": "Go to the Emergency Department immediately \u2014 minutes matter for saving your vision", "severity": "critical"},
        {"if_sign": "you see a curtain or shadow covering part of your vision",
         "then_action": "Go to the Emergency Department immediately \u2014 this could be a retinal detachment", "severity": "critical"},
        {"if_sign": "a chemical splashed in your eye",
         "then_action": "Flush with clean water for 15 minutes and go to the ER right away", "severity": "critical"},
        {"if_sign": "eye pain gets worse with redness, swelling, and fever",
         "then_action": "Go to the Emergency Department \u2014 this could be an eye infection spreading", "severity": "critical"},
    ],
    "fracture": [
        {"if_sign": "you notice increasing numbness, tingling, or your fingers/toes turn pale or blue",
         "then_action": "Go to the Emergency Department \u2014 blood flow may be compromised", "severity": "critical"},
        {"if_sign": "you cannot bear weight or the limb looks deformed",
         "then_action": "Go to the Emergency Department or Urgent Care for X-rays", "severity": "urgent"},
        {"if_sign": "pain and swelling get much worse despite rest, ice, and elevation",
         "then_action": "See a doctor within 24 hours", "severity": "urgent"},
    ],
    "pelvic_pain": [
        {"if_sign": "you develop sudden severe pelvic pain with dizziness or fainting",
         "then_action": "Call 911 \u2014 this could be a ruptured ectopic pregnancy or ovarian torsion", "severity": "critical"},
        {"if_sign": "pelvic pain comes with heavy vaginal bleeding and you might be pregnant",
         "then_action": "Go to the Emergency Department immediately", "severity": "critical"},
        {"if_sign": "pelvic pain gets worse with fever and unusual discharge",
         "then_action": "See a doctor within 24 hours", "severity": "urgent"},
    ],
    "laceration": [
        {"if_sign": "the bleeding won't stop after 15 minutes of firm pressure",
         "then_action": "Go to the Emergency Department", "severity": "urgent"},
        {"if_sign": "blood is squirting or pulsing from the wound",
         "then_action": "Apply firm pressure and call 911 \u2014 an artery may be cut", "severity": "critical"},
        {"if_sign": "the wound gets red, swollen, warm, or starts oozing pus",
         "then_action": "See a doctor within 24 hours \u2014 the wound may be infected", "severity": "urgent"},
        {"if_sign": "you develop a fever after a wound",
         "then_action": "See a doctor right away \u2014 the wound may be infected", "severity": "urgent"},
    ],
    "swelling": [
        {"if_sign": "one leg suddenly swells with calf pain",
         "then_action": "Go to the Emergency Department \u2014 this could be a blood clot (DVT)", "severity": "critical"},
        {"if_sign": "swelling comes with trouble breathing",
         "then_action": "Call 911 \u2014 swelling with breathing problems could indicate heart failure or a blood clot in the lung", "severity": "critical"},
    ],
    "extremity_pain": [
        {"if_sign": "you develop sudden severe leg or arm swelling with pain",
         "then_action": "Go to the Emergency Department \u2014 this could be a blood clot", "severity": "critical"},
        {"if_sign": "you notice the limb looks deformed or you heard a pop",
         "then_action": "Go to Urgent Care or the Emergency Department for X-rays", "severity": "urgent"},
        {"if_sign": "pain doesn't improve after a few days of rest and OTC medication",
         "then_action": "See a doctor", "severity": "watch"},
    ],
    "substance_use": [
        {"if_sign": "you develop chest pain, seizures, or confusion",
         "then_action": "Call 911 immediately", "severity": "critical"},
        {"if_sign": "breathing becomes very slow or the person can't be woken up",
         "then_action": "Call 911 \u2014 this could be an overdose. Use Narcan (naloxone) if available", "severity": "critical"},
    ],
}
...
SYMPTOM_HOME_REMEDIES = {
    ...
    "eye_problem": [
        {"remedy": "Artificial tears", "detail": "Over-the-counter lubricating eye drops can help with dryness and irritation."},
        {"remedy": "Cool compress", "detail": "A cool, clean cloth over closed eyes for 10 minutes can relieve redness and swelling."},
        {"remedy": "Remove contact lenses", "detail": "Take out contacts and switch to glasses until the problem clears up."},
        {"remedy": "Avoid rubbing your eye", "detail": "Rubbing can make irritation, swelling, and scratches worse."},
        {"remedy": "Do NOT apply pressure to the eye", "detail": "If the eye is injured, do not press on it or try to remove anything stuck in it."},
    ],
    "fracture": [
        {"remedy": "RICE method", "detail": "Rest, Ice (20 min on, 20 min off), Compression (wrap if possible), Elevation (raise it up)."},
        {"remedy": "Immobilize the area", "detail": "Keep the injured area still with a splint, sling, or by taping the injured finger to the next one."},
        {"remedy": "Over-the-counter pain relief", "detail": "Ibuprofen (Advil) or acetaminophen (Tylenol) as directed on the label."},
        {"remedy": "Avoid using the injured area", "detail": "Don't put weight on it or use it until you've seen a doctor."},
    ],
    "injury_fall": [
        {"remedy": "RICE method", "detail": "Rest, Ice (20 min on, 20 min off), Compression (wrap if possible), Elevation (raise it up)."},
        {"remedy": "Over-the-counter pain relief", "detail": "Ibuprofen or acetaminophen as directed on the label."},
        {"remedy": "Watch for delayed symptoms", "detail": "After a head injury, watch for worsening headache, vomiting, or confusion for 24 hours."},
        {"remedy": "Clean minor scrapes", "detail": "Rinse with clean water, apply antibiotic ointment, and cover with a bandage."},
    ],
    "pelvic_pain": [
        {"remedy": "Warm compress", "detail": "A heating pad or warm towel on your lower belly can help relax cramps."},
        {"remedy": "Over-the-counter pain relief", "detail": "Ibuprofen (Advil) or naproxen (Aleve) works well for menstrual cramps and pelvic discomfort."},
        {"remedy": "Stay hydrated", "detail": "Drinking plenty of water helps, especially if urinary symptoms are involved."},
        {"remedy": "Rest", "detail": "Lie in a comfortable position with knees pulled up if that helps."},
    ],
    "swelling": [
        {"remedy": "Elevate the swollen area", "detail": "Raise the swollen limb above the level of your heart when resting."},
        {"remedy": "Reduce salt intake", "detail": "Too much salt can make swelling worse. Avoid salty foods for a few days."},
        {"remedy": "Gentle movement", "detail": "Light walking or ankle pumps can help reduce fluid buildup in legs."},
        {"remedy": "Compression", "detail": "Compression stockings or an elastic bandage can help reduce swelling."},
    ],
    "weakness": [
        {"remedy": "Rest and pace yourself", "detail": "Alternate between rest and light activity. Don't push through severe weakness."},
        {"remedy": "Stay hydrated and eat well", "detail": "Dehydration and low blood sugar can cause weakness. Drink water and eat balanced meals."},
        {"remedy": "Review your medications", "detail": "Check if any new or changed medications could be causing weakness."},
        {"remedy": "Gentle stretching", "detail": "Light stretching can help if the weakness is from inactivity or bed rest."},
    ],
    "laceration": [
        {"remedy": "Apply pressure", "detail": "Use a clean cloth and apply firm pressure for at least 10-15 minutes to stop bleeding."},
        {"remedy": "Clean the wound", "detail": "Rinse with clean running water for 5 minutes. Do NOT use hydrogen peroxide or alcohol directly on the wound."},
        {"remedy": "Apply antibiotic ointment", "detail": "A thin layer of over-the-counter antibiotic ointment (like Neosporin) after cleaning."},
        {"remedy": "Cover with a clean bandage", "detail": "Keep the wound covered and change the bandage daily or when it gets wet."},
        {"remedy": "Watch for infection", "detail": "Check daily for increasing redness, swelling, warmth, or pus."},
    ],
}
...
SYMPTOM_DIFFERENTIALS = {
    "chest_pain": [
        ...
        {"diagnosis": "Myocarditis", "likelihood": "Uncommon", "notes": "Chest pain with recent viral illness; fatigue; may mimic heart attack in young patients"},
        {"diagnosis": "Aortic dissection", "likelihood": "Rare", "notes": "Tearing pain radiating to back; hypertension; medical emergency"},
        {"diagnosis": "Boerhaave syndrome (esophageal rupture)", "likelihood": "Rare", "notes": "Severe chest pain after forceful vomiting; surgical emergency"},
    ],
    "shortness_of_breath": [
    ...
    "headache": [
        ...
        {"diagnosis": "Giant cell arteritis (GCA)", "likelihood": "Uncommon", "notes": "New headache in age >50; jaw claudication; scalp tenderness; can cause blindness"},
        {"diagnosis": "Cerebral venous thrombosis", "likelihood": "Rare", "notes": "Headache with seizures or focal deficits; risk with pregnancy, OCP use"},
    ...
    "abdominal_pain": [
        ...
        {"diagnosis": "Abdominal aortic aneurysm (AAA)", "likelihood": "Rare", "notes": "Sudden abdominal/back pain with dizziness in older adults; medical emergency"},
        {"diagnosis": "Mesenteric ischemia", "likelihood": "Rare", "notes": "Severe pain out of proportion to exam; older adults with atrial fibrillation or vascular disease"},
        {"diagnosis": "Ovarian torsion", "likelihood": "Rare", "notes": "Sudden severe unilateral pelvic pain in reproductive-age female; nausea; surgical emergency"},
    ],
    "fever": [
        ...
        {"diagnosis": "Endocarditis", "likelihood": "Uncommon", "notes": "Fever with new heart murmur; IV drug use or prosthetic valve; requires blood cultures"},
        {"diagnosis": "Epidural abscess", "likelihood": "Rare", "notes": "Fever with back pain; IV drug use risk; can cause paralysis if missed"},
        {"diagnosis": "Necrotizing fasciitis", "likelihood": "Rare", "notes": "Fever with rapidly spreading pain, redness, and skin breakdown; surgical emergency"},
    ...
    "dizziness": [
        ...
        {"diagnosis": "Medication side effect", "likelihood": "Common", "notes": "New or changed medication; blood pressure pills, sedatives, or antibiotics"},
        ...
        {"diagnosis": "Posterior circulation stroke (PICA)", "likelihood": "Rare", "notes": "Vertigo with ataxia, diplopia, or dysarthria; risk with hypertension; emergency"},
    ...
    "neck_pain": [
        ...
        {"diagnosis": "Retropharyngeal abscess", "likelihood": "Rare", "notes": "Neck pain with fever, difficulty swallowing; can obstruct airway; emergency"},
        {"diagnosis": "Ludwig angina", "likelihood": "Rare", "notes": "Floor-of-mouth infection; jaw swelling, tongue elevation, drooling; airway emergency"},
        {"diagnosis": "Carotid dissection", "likelihood": "Rare", "notes": "Neck pain with headache after trauma; can cause stroke; emergency"},
    ...
    "back_pain": [
        ...
        {"diagnosis": "Epidural abscess", "likelihood": "Rare", "notes": "Back pain with fever and IV drug use or immunosuppression; spinal cord emergency"},
        {"diagnosis": "Abdominal aortic aneurysm (AAA)", "likelihood": "Rare", "notes": "Sudden back pain with abdominal pain and dizziness in older adults; emergency"},
    ...
    "weakness": [
        {"diagnosis": "Deconditioning / Fatigue", "likelihood": "Very common", "notes": "Generalized weakness from illness, poor sleep, or inactivity"},
        {"diagnosis": "Dehydration / Electrolyte imbalance", "likelihood": "Common", "notes": "Weakness with poor intake, diarrhea, or vomiting"},
        {"diagnosis": "Medication side effect", "likelihood": "Common", "notes": "New or changed medication; statins, blood pressure pills, sedatives"},
        {"diagnosis": "Anemia", "likelihood": "Less common", "notes": "Gradual weakness with fatigue, pallor, shortness of breath"},
        {"diagnosis": "Stroke / TIA", "likelihood": "Less common", "notes": "Sudden one-sided weakness with speech or vision changes; emergency"},
        {"diagnosis": "Spinal cord compression", "likelihood": "Uncommon", "notes": "Progressive weakness in legs; bladder dysfunction; cancer or disc herniation"},
        {"diagnosis": "Guillain-Barré syndrome", "likelihood": "Rare", "notes": "Ascending weakness starting in legs; tingling; recent viral illness; emergency"},
        {"diagnosis": "Myasthenia gravis", "likelihood": "Rare", "notes": "Weakness worse with activity; drooping eyelids; difficulty swallowing"},
        {"diagnosis": "Hyperkalemia", "likelihood": "Rare", "notes": "Weakness with kidney disease or certain medications; can cause cardiac arrest"},
    ],
    "sore_throat": [
        ...
        {"diagnosis": "Epiglottitis", "likelihood": "Rare", "notes": "Drooling, stridor, toxic appearance; airway emergency"},
        {"diagnosis": "Retropharyngeal abscess", "likelihood": "Rare", "notes": "Sore throat with stiff neck, fever, no trismus; airway risk"},
        {"diagnosis": "Ludwig angina", "likelihood": "Rare", "notes": "Floor-of-mouth swelling, tongue elevation, trismus; airway emergency"},
    ],
    "cough": [
    ...
    "eye_problem": [
        ...
        {"diagnosis": "Iritis / Anterior uveitis", "likelihood": "Uncommon", "notes": "Eye pain, photophobia, blurred vision; autoimmune association"},
        {"diagnosis": "Orbital cellulitis", "likelihood": "Uncommon", "notes": "Eye swelling, pain, fever, proptosis; infection spreading from sinuses; emergency"},
        {"diagnosis": "Acute angle-closure glaucoma", "likelihood": "Rare", "notes": "Severe eye pain, blurred vision, halos, nausea; emergency — can cause blindness"},
        {"diagnosis": "Central retinal artery occlusion", "likelihood": "Rare", "notes": "Sudden painless vision loss in one eye; vascular emergency; minutes matter"},
    ...
    "laceration": [
        {"diagnosis": "Simple laceration", "likelihood": "Very common", "notes": "Clean cut through skin; may need stitches if gaping or deep"},
        {"diagnosis": "Contaminated wound", "likelihood": "Common", "notes": "Dirty wound or bite; high infection risk; needs cleaning and possibly antibiotics"},
        {"diagnosis": "Tendon injury", "likelihood": "Less common", "notes": "Deep cut with inability to move finger/toe/joint; needs surgical repair"},
        {"diagnosis": "Nerve injury", "likelihood": "Less common", "notes": "Cut with numbness or loss of sensation past the wound"},
        {"diagnosis": "Arterial laceration", "likelihood": "Uncommon", "notes": "Pulsating or spurting blood; may need surgical repair; emergency"},
    ],
    "pelvic_pain": [
